...
```
We kept `r NROW(keep.govc.indicator)-1` indicators and there were `r NROW(govc_codes)`selected in the first place : all of them were well documented accross the sample of countries.